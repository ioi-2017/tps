 ...
 * Kian Mirjalali:
 *
 * Modified to be compatible with CMS for IOI2017
 *
 ...
 *
 * * Changed quit behaviors to make it compliant with CMS.
 *
 * * The exit codes are set to be always 0.
 *
...
//Checker should always return 0 in CMS:
...
{
    setName(("checker for problem "+probName).c_str());
